...
# trains scheduler and precoder for generalizing the number of RBs (M)
...
if __name__ == '__main__':
    ...
    # hyper parameters
    BATCH_SIZE = 50 # or 100 500, could be large if GPU memory allowed
