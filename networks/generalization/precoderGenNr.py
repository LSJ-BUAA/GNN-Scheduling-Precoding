...
# trains precoder for generalizing the number of UE-ANs (NR)
...
if __name__ == '__main__':
    ...
    print('BatchSize', BATCH_SIZE, 'ini_LEARNING_RATE', LEARNING_RATE, 'layer', layer, 'atten', is_attention, 'NRtest',NRtest)
