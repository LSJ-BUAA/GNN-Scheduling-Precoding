...
# trains scheduler and precoder for generalizing the number of UEs (K>NRF)
...
if __name__ == '__main__':
    ...
    w1 = 8 # 6 when NRF is small and K is large, 12 when NRF is large
    w2 = 4
    ...
    print('Sequential',is_sequential,'BatchSize',BATCH_SIZE,'ini_LEARNING_RATE',LEARNING_RATE,LR2,'layerM',layerM,'atten',is_attention, 'epoch_train_precoder',epoch_train_precoder, 'feature_weight',w1,w2, 'Ktest',Kintest)
